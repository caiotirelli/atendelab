...
switch ($controller) {
    ...
    case 'frontend':
        ...
        switch ($action) {
            ...
            default: http_response_code(404); echo 'Pagina nao encontrada.';
        }
        break;
    ...
    case 'usuarios':
        ...
        switch ($action) {
            ...
            case 'buscar':      $usuariosController->buscar();      break;
            case 'buscarPorId': $usuariosController->buscarPorId(); break;
            case 'criar':       exigirAdmin(); $usuariosController->criar();       break;
            case 'atualizar':   exigirAdmin(); $usuariosController->atualizar();   break;
            case 'excluir':     exigirAdmin(); $usuariosController->excluir();     break;
            default: http_response_code(404); echo 'Acao nao encontrada.';
        }
        break;
