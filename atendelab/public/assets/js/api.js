window.AtendeLabApi = (() => {
    ...
    return { get: (controller, action, query = {}) => request(controller, action, { query }), post: (controller, action, body = {}) => request(controller, action, { method: 'POST', body }), toList, toObject, escape, escapeAttr, showAlert };
})();