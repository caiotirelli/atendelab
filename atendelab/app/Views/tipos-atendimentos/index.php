...
async function carregarTipos() {
    try {
        ...
        if (!tipos.length) { tabelaTipos.innerHTML = '<tr><td colspan="4" class="text-center py-4">Nenhum tipo cadastrado.</td></tr>'; return; }
        tabelaTipos.innerHTML = tipos.map(tipo => `<tr>
